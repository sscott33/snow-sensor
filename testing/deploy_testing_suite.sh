...
the I2C sensors. Test scripts will be written to the /home/pi/testing
directory. Please note that this testing suite makes use of free
licensed open source software. Please see the licensing files
